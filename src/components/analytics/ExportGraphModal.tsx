    ...
    <Modal minWidth='95%' maxWidth='400px' maxHeight='95%' onClose={onClose}>
      <div className='flex flex-col gap-3'>
        <div className='flex h-full w-full flex-col gap-3'>
          <span className='text-text-lg font-semibold'>{t("analytics.exportGraph")}</span>
        </div>
        <div className='flex flex-col gap-2'>
          <div className='flex items-start gap-1/2'>
            ...
            <div className='flex h-full flex-col'>
              <span className='text-text-sm font-medium'>{t("analytics.csvFormat")}</span>
          ...
          <div className='flex items-start gap-1/2'>
            ...
            />
            <div className='flex h-full flex-col'>
              <span className='text-text-sm font-medium'>{t("analytics.pngFormat")}</span>
              <span className='text-text-sm text-grayTextPrimary'>
        ...
        <div className='flex items-center justify-between gap-1.5'>
          <button
            ...
            onClick={onClose}
          >
            <span className='text-text-md font-semibold'>{t("actions.cancel")}</span>
          </button>
          <button
