    ...
    <div className='flex flex-col gap-2 pt-4'>
      <div className='flex flex-col gap-4 md:flex-row md:gap-6'>
        <div className='flex flex-1 flex-col gap-2'>
          <span className='text-text-sm font-medium'>{t("pools.detailPage.embed.spoDelegationButton")}</span>
        ...
        <div className='flex flex-col gap-2'>
          <span className='text-text-sm font-medium'>{t("pools.detailPage.embed.preview")}</span>
          <a
            href={previewUrl}
            target='_blank'
