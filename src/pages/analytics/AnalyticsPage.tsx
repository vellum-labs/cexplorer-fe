...
export const AnalyticsPage = () => {
  ...
  return (
    ...
    >
      <section className='mt-2 grid w-full max-w-desktop grid-cols-1 gap-5 px-mobile pb-3 md:grid-cols-2 md:px-desktop'>
        {Object.keys(options)
          ...
          .map(key => (
            ...
            >
              ...
              <div className='mt-1 grid grid-flow-col grid-cols-2 grid-rows-4 gap-2'>
