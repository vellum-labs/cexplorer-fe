    ...
    <>
      ...
      <main className='flex min-h-minHeight w-full flex-col items-center'>
        ...
        <div className='m-4 flex h-auto w-full max-w-desktop justify-center rounded-lg p-mobile hover:text-text md:m-5 md:p-desktop'>
          <div className='flex w-full max-w-desktop flex-col-reverse justify-center gap-3 rounded-lg border border-border bg-gradient-to-b from-bannerGradient to-darker p-5 md:flex-row'>
